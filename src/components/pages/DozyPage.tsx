...
export function DozyPage({ onAppClick }: DozyPageProps) {
  const config = {
    name: "Dozy",
    slug: "dozy",
    logo: dozyLogo,
    ...
    featuresTitle: "Why Commuters Trust Dozy",
    featuresSubtitle: "Discover the intelligent features that make Dozy the ultimate travel companion for stress-free commuting.",
